...
if sig_area == '구간A)첨단지구(과기원)-극락교(송정)':
    ...
    # 첫 번째 차트
        ...
        st.markdown(
            '''
            1. 내일 새벽~아침 내륙 중심 안개 곳
            2.  :blue[빙판길]과 :red[도로 살얼음] 주의
            ''')
        st.subheader("2월 26일 광주ASOS 기상관측 정보(06시/07시)")
        st.markdown(
            '''
            1. 06시 : 1. 기온 0.9 °C, 2. 습도 99%, 3. 운량 상층운 4할, 4. 지면온도 0.1 °C, 풍속 0.5m/s 박무 낌 
            2. 07시 : 1. 기온 1.0 °C, 2. 습도 99%, 3. 운량 상층운 2할, 4. 지면온도 -0.1 °C, 풍속 0.8m/s 박무 낌 
            3. 전일(28일) 총 일사/ 평균 일조율 : 11.22 MJ/m^2, 64.4%
            '''
        )
    ...
    # 두 번째 차트
        ...
        st.markdown(
            '''
            1. 내일 새벽~아침 내륙중심 안개 곳,. :red[도로 살얼음] 주의
            ''')
        st.subheader("2월 27일 광주ASOS 기상관측 정보(06시/07시)")
        st.markdown(
            '''
            1. 06시 : 1. 기온 2.9 °C, 2. 습도 95%, 3. 운량 하층운 4할(운고 1km), 4. 지면온도 0.4 °C, 풍속 2.1m/s 
            2. 07시 : 1. 기온 2.6 °C, 2. 습도 94%, 3. 운량 중층운 8할(운고 3.6km), 4. 지면온도 0.7 °C, 풍속 1.0m/s 
            '''
        )
