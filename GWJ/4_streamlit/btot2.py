...
def create_graph(df2):
    ...
    ## 교량 표시를 위한 주석 추가(과기원 앞 ~ 비아 지하차도)
    fig.add_annotation(
        x='2024-02-07 06:14:49',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:14:49', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '과학기술원 앞 ~ 비아지하차도',
        showarrow=True,  # 화살표 표시 여부
        ax=5,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=30,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    fig.add_annotation(
        x='2024-02-07 06:20:43',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:20:43', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '하남교',
        showarrow=True,  # 화살표 표시 여부
        ax=15,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=55,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(하남교IN)
    fig.add_annotation(
        x='2024-02-07 06:23:02',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:23:02', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '산단구간 시작(6번로)',
        showarrow=True,  # 화살표 표시 여부
        ax=15,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=55,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
       ...
       ## 교량 표시를 위한 주석 추가(하남교OUT)
    fig.add_annotation(
        x='2024-02-07 06:26:47',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:26:47', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '산단구간 종료(흑석사거리)',
        showarrow=True,  # 화살표 표시 여부
        ax=-15,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=75,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(하남교OUT)
    fig.add_annotation(
        x='2024-02-07 06:28:35',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:28:35', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '원곡교',
        showarrow=True,  # 화살표 표시 여부
        ax=-15,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=75,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(신단관리소 사거리)
    fig.add_annotation(
        x='2024-02-07 06:29:56',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:29:56', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '광주여대 입구',
        showarrow=True,  # 화살표 표시 여부
        ax=-10,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=85,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(흑석 사거리)
    fig.add_annotation(
        x='2024-02-07 06:33:30',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:33:30', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '남성 저수지',
        showarrow=True,  # 화살표 표시 여부
        ax=-5,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=75,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(원곡교IN)
    fig.add_annotation(
        x='2024-02-07 06:36:06',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:36:06', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '송정 고가차도',
        showarrow=True,  # 화살표 표시 여부
        ax=-5,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=75,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
    ...
    ## 교량 표시를 위한 주석 추가(원곡교OUT)
    fig.add_annotation(
        x='2024-02-07 06:40:28',  # 주석을 달고 싶은 x축 좌표 위치
        y=df2_cleaned.loc[df2_cleaned['시간'] == '2024-02-07 06:40:28', '노면온도'].values[0],  # 해당 시간의 노면온도
        text = '극락교',
        showarrow=True,  # 화살표 표시 여부
        ax=-5,  # 화살표의 x축 방향 길이 (음수 값 사용하여 반대 방향으로 설정)
        ay=75,  # 화살표의 y축 방향 길이 (음수 값 사용하여 반대 방향으로 설정 # 화살표 방향을 반대로 설정
